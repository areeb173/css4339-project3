...
export const apiClient = axios.create({
  baseURL: import.meta.env.VITE_API_BASE_URL || import.meta.env.VITE_API_URL || "http://localhost:3001",
...
const api = {
  ...
  createPhoto(url) {
    return unwrap(apiClient.post("/photos", { url }));
  },
  togglePhotoLike(photoId) {
    return unwrap(apiClient.post(`/photos/${photoId}/like`, {}));
  },
